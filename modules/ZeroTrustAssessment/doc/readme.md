...
This fork runs only on Ubuntu 24.04 or newer and writes assessment data to PostgreSQL. It does not use local database files or Windows native database dependencies.
